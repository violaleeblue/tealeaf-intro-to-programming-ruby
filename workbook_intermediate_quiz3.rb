...
puts "I ran the code and was surprised that outer objects a and d had the same id before the block. It makes sense that"
puts "the rescue code would execute after the block when the inner object ids are called, because those objects are out of scope."
...
puts "the method makes no difference, it works exactly the same way. illustrates pass by value as opposed to pass by reference"
...
puts "the shovel operator mutates the caller"
...
puts "in this case, gsub mutates the caller"
